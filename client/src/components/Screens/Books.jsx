...
function Books() {
            ...
            <div className="container-fluid">
                <div className="row">
                    <div className="col-md-12 text-center">
                        <h5 className="display-5 text-success">No Books List</h5>
                    </div>
                </div>
            </div>
        )
  ...
  return (
    <div className="container-fluid">
        <div className="row">
            <div className="col-md-12 text-center">
                <h5 className="display-5 text-success">Books Lists</h5>
            </div>
        </div>
        <div className="row">
                            ...
                            books && books.map((item,index) => {
                                ...
                                return(
                                    <tr className="text-center" key={index}>
                                        <td>{title}</td>
                                        <td>
                                            <img src={image.url ? image.url : '#'} alt="no image" width={100} className="img-fluid" />
                                        </td>
                                        <td>{author}</td>
                                        <td>{pages}</td>
                                        <td>&#8377; {price}</td>
