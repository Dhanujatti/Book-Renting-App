                        ...
                        <div className="card-body">
                            <form autoComplete='off' onSubmit={submitHandler}>
                                ...
                                <div className="form-group mt-2">
                                    ...
                                    <input type="number" name="amount" id="amount" value={amount} onChange={(e) => setAmount(e.target.value) } className='form-control' readOnly/>
                                </div>
                                <div className="form-group mt-2">
                                ...
                                <div className="form-group mt-2">
                                    <input type="submit" value="Update book" className='btn btn-outline-success' />
                                </div>
                            </form>
                        </div>
                    </div>
